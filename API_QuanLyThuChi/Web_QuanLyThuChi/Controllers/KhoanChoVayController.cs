...
{
    public class KhoanChoVayController : BaseController
    {
        ...
        [HttpGet]
        public ActionResult ThemKhoanChoVay()
        {
        ...
        public KhoanVay_ChoVay LayKhoanChoVayTheoMa(int id)
        {
            KhoanVay_ChoVay kt = new KhoanVay_ChoVay();
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(baseAddress);
                //HTTP GET
                var responseTask = client.GetAsync($"KhoanChoVay/{id}");
                responseTask.Wait();
        ...
        [HttpGet]
        public ActionResult SuaKhoanChoVay(int id)
        {
            LoadDataForComboLoaiTaiKhoan();
            LoadDataForComboNguoiVay();

            KhoanVay_ChoVay res = new KhoanVay_ChoVay();
            res = LayKhoanChoVayTheoMa(id);

            return View(res);
        }

        [HttpPost]
        public ActionResult SuaKhoanChoVay(int id, DateTime ngayvay, int sotien, string nguoivay, string taikhoanchitieu)
        {
            KhoanVay_ChoVay kt = new KhoanVay_ChoVay();
            kt.id = id;
            kt.ngayvay = ngayvay;
        ...
        public ActionResult Delete(int id)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(baseAddress);
                //HTTP GET
                var deleteTask = client.DeleteAsync("KhoanChoVay?id=" + id);
                deleteTask.Wait();
